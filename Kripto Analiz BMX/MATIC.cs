...
namespace Kripto_Analiz_BMX
{
    public partial class MATIC : Form
    {
        ...
        //Matic
        private static double MATICLastPrice()
        {


            WebClient wb = new WebClient();
            string btc = wb.DownloadString("https://api.binance.com/api/v3/ticker/24hr?symbol=MATICUSDT");
        ...
        private static double MATICMaxPrice()
        {
        ...
        private static double MATICMinPrice()
        {
        ...
        private static double MATIC24Change()
        {
        ...
        private static double MATIC24Average()
        {
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            label4.Text = String.Format("{0:00,000}", (MATICLastPrice() / 10000)); // son değer
            label5.Text = String.Format("{0:00,000}", (MATICMaxPrice() / 10000)); // max değer
            label18.Text = String.Format("{0:00,000}", (MATICMinPrice() / 10000)); // min değer 
            label19.Text = String.Format("{0:00,000}", (MATIC24Change() / 10000)); // 24 saat değişim
            label20.Text = String.Format("{0:00,000}", (MATIC24Average() / 10000)); // 24 saatlik ortalama
            double btcavarage = MATIC24Average();
