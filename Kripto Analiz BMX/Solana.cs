...
{
    public partial class Solana : Form
    {
        //SOL
        private static double SOLLastPrice()
        {


            WebClient wb = new WebClient();
            string btc = wb.DownloadString("https://api.binance.com/api/v3/ticker/24hr?symbol=SOLUSDT");
        ...
        private static double SOLMaxPrice()
        {
        ...
        private static double SOLMinPrice()
        {
        ...
        private static double SOL24Change()
        {
        ...
        private static double SOL24Average()
        {
        ...
        private void Solana_Load(object sender, EventArgs e)
        {
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            DovizGoster();
            label4.Text = String.Format("{0:00,000}", (SOLLastPrice() / 10000)); // son değer
            label5.Text = String.Format("{0:00,000}", (SOLMaxPrice() / 10000)); // max değer
            label18.Text = String.Format("{0:00,000}", (SOLMinPrice() / 10000)); // min değer 
            label19.Text = String.Format("{0:00,000}", (SOL24Change() / 10000)); // 24 saat değişim
            label20.Text = String.Format("{0:00,000}", (SOL24Average() / 10000)); // 24 saatlik ortalama
            double btcavarage = SOL24Average();
