...
{
    public partial class ICP : Form
    {
        //ICP
        private static double ICPLastPrice()
        {


            WebClient wb = new WebClient();
            string btc = wb.DownloadString("https://api.binance.com/api/v3/ticker/24hr?symbol=ICPUSDT");
        ...
        private static double ICPMaxPrice()
        {
        ...
        private static double ICPMinPrice()
        {
        ...
        private static double ICP24Change()
        {
        ...
        private static double ICP24Average()
        {
        ...
        private void ICP_Load(object sender, EventArgs e)
        {
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            label4.Text = String.Format("{0:00,000}", (ICPLastPrice() / 10000)); // son değer
            label5.Text = String.Format("{0:00,000}", (ICPMaxPrice() / 10000)); // max değer
            label18.Text = String.Format("{0:00,000}", (ICPMinPrice() / 10000)); // min değer 
            label19.Text = String.Format("{0:00,000}", (ICP24Change() / 10000)); // 24 saat değişim
            label20.Text = String.Format("{0:00,000}", (ICP24Average() / 10000)); // 24 saatlik ortalama
            double btcavarage = ICP24Average();
