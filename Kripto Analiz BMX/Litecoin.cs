...
{
    public partial class Litecoin : Form
    {
        //Litecoin
        private static double LTCLastPrice()
        {


            WebClient wb = new WebClient();
            string btc = wb.DownloadString("https://api.binance.com/api/v3/ticker/24hr?symbol=LTCUSDT");
        ...
        private static double LTCMaxPrice()
        {
        ...
        private static double LTCMinPrice()
        {
        ...
        private static double LTC24Change()
        {
        ...
        private static double LTC24Average()
        {
        ...
        private void Litecoin_Load(object sender, EventArgs e)
        {
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            label4.Text = String.Format("{0:00,000}", (LTCLastPrice() / 10000)); // son değer
            label5.Text = String.Format("{0:00,000}", (LTCMaxPrice() / 10000)); // max değer
            label18.Text = String.Format("{0:00,000}", (LTCMinPrice() / 10000)); // min değer 
            label19.Text = String.Format("{0:00,000}", (LTC24Change() / 10000)); // 24 saat değişim
            label20.Text = String.Format("{0:00,000}", (LTC24Average() / 10000)); // 24 saatlik ortalama
            double btcavarage = LTC24Average();
            ...
            double alb1 = btcavarage - destek1;
            double alb2 = direnc1 - btcavarage;
