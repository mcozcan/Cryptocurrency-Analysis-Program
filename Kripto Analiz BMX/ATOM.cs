...
namespace Kripto_Analiz_BMX
{
    ...
    public partial class ATOM : Form
    {
        ...
        //Cosmos Atom
        private static double ATOMLastPrice()
        {


            WebClient wb = new WebClient();
            string btc = wb.DownloadString("https://api.binance.com/api/v3/ticker/24hr?symbol=ATOMUSDT");
        ...
        private static double ATOMMaxPrice()
        {
        ...
        private static double ATOMMinPrice()
        {
        ...
        private static double ATOM24Change()
        {
        ...
        private static double ATOM24Average()
        {
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            label4.Text = String.Format("{0:00,000}", (ATOMLastPrice() / 10000)); // son değer
            label5.Text = String.Format("{0:00,000}", (ATOMMaxPrice() / 10000)); // max değer
            label18.Text = String.Format("{0:00,000}", (ATOMMinPrice() / 10000)); // min değer 
            label19.Text = String.Format("{0:00,000}", (ATOM24Change() / 10000)); // 24 saat değişim
            label20.Text = String.Format("{0:00,000}", (ATOM24Average() / 10000)); // 24 saatlik ortalama
            double btcavarage = ATOM24Average();
