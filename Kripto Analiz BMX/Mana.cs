...
namespace Kripto_Analiz_BMX
{
    public partial class Mana : Form
    {
        ...
        //Mana
        private static double MANALastPrice()
        {


            WebClient wb = new WebClient();
            string btc = wb.DownloadString("https://api.binance.com/api/v3/ticker/24hr?symbol=MANAUSDT");
        ...
        private static double MANAMaxPrice()
        {
        ...
        private static double MANAMinPrice()
        {
        ...
        private static double MANA24Change()
        {
        ...
        private static double MANA24Average()
        {
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            label4.Text = String.Format("{0:00,000}", (MANALastPrice() / 10000)); // son değer
            label5.Text = String.Format("{0:00,000}", (MANAMaxPrice() / 10000)); // max değer
            label18.Text = String.Format("{0:00,000}", (MANAMinPrice() / 10000)); // min değer 
            label19.Text = String.Format("{0:00,000}", (MANA24Change() / 10000)); // 24 saat değişim
            label20.Text = String.Format("{0:00,000}", (MANA24Average() / 10000)); // 24 saatlik ortalama
            double btcavarage = MANA24Average();
