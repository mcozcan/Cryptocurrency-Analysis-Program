...
{
    public partial class BitcoinCash : Form
    {
        ...
        //Bitcoin Cash BCH
        private static double BCHLastPrice()
        {


            WebClient wb = new WebClient();
            string btc = wb.DownloadString("https://api.binance.com/api/v3/ticker/24hr?symbol=BCHUSDT");
        ...
        private static double BCHMaxPrice()
        {
        ...
        private static double BCHMinPrice()
        {
        ...
        private static double BCH24Change()
        {
        ...
        private static double BCH24Average()
        {
        ...
        private void BitcoinCash_Load(object sender, EventArgs e)
        {
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            label4.Text = String.Format("{0:00,000}", (BCHLastPrice() / 10000)); // son değer
            label5.Text = String.Format("{0:00,000}", (BCHMaxPrice() / 10000)); // max değer
            label18.Text = String.Format("{0:00,000}", (BCHMinPrice() / 10000)); // min değer 
            label19.Text = String.Format("{0:00,000}", (BCH24Change() / 10000)); // 24 saat değişim
            label20.Text = String.Format("{0:00,000}", (BCH24Average() / 10000)); // 24 saatlik ortalama
            double btcavarage = BCH24Average();
