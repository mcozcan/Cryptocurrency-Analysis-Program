...
{
    public partial class AVAX : Form
    {
        ...
        private static double AVAXLastPrice()
        {


            WebClient wb = new WebClient();
            string btc = wb.DownloadString("https://api.binance.com/api/v3/ticker/24hr?symbol=AVAXUSDT");
        ...
        private static double AVAXMaxPrice()
        {
        ...
        private static double AVAXMinPrice()
        {
        ...
        private static double AVAX24Change()
        {
        ...
        private static double AVAX24Average()
        {
        ...
        private void AVAX_Load(object sender, EventArgs e)
        {
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            label4.Text = String.Format("{0:00,000}", (AVAXLastPrice() / 10000)); // son değer
            label5.Text = String.Format("{0:00,000}", (AVAXMaxPrice() / 10000)); // max değer
            label18.Text = String.Format("{0:00,000}", (AVAXMinPrice() / 10000)); // min değer 
            label19.Text = String.Format("{0:00,000}", (AVAX24Change() / 10000)); // 24 saat değişim
            label20.Text = String.Format("{0:00,000}", (AVAX24Average() / 10000)); // 24 saatlik ortalama
            double btcavarage = AVAX24Average();
