...
namespace Kripto_Analiz_BMX
{
    public partial class Ethereum : Form
    {
        ...
        private static double ethLastPrice()
        {


            WebClient wb = new WebClient();
            string btc = wb.DownloadString("https://api.binance.com/api/v3/ticker/24hr?symbol=ETHUSDT");
        ...
        private static double ethMaxPrice()
        {
        ...
        private static double ethMinPrice()
        {
        ...
        private static double eth24Change()
        {
        ...
        private static double eth24Average()
        {
        ...
        private void Ethereum_Load(object sender, EventArgs e)
        {
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            label4.Text = String.Format("{0:00,000}", (ethLastPrice() / 10000)); // son değer
            label5.Text = String.Format("{0:00,000}", (ethMaxPrice() / 10000)); // max değer
            label18.Text = String.Format("{0:00,000}", (ethMinPrice() / 10000)); // min değer 
            label19.Text = String.Format("{0:00,000}", (eth24Change() / 10000)); // 24 saat değişim
            label20.Text = String.Format("{0:00,000}", (eth24Average() / 10000)); // 24 saatlik ortalama
            double btcavarage = eth24Average();
