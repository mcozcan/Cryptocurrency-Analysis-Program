...
{
    public partial class Uniswap : Form
    {
        //Uniswap UNI
        private static double UNILastPrice()
        {


            WebClient wb = new WebClient();
            string btc = wb.DownloadString("https://api.binance.com/api/v3/ticker/24hr?symbol=UNIUSDT");
        ...
        private static double UNIMaxPrice()
        {
        ...
        private static double UNIMinPrice()
        {
        ...
        private static double UNI24Change()
        {
        ...
        private static double UNI24Average()
        {
        ...
        private void Uniswap_Load(object sender, EventArgs e)
        {
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            label4.Text = String.Format("{0:00,000}", (UNILastPrice() / 10000)); // son değer
            label5.Text = String.Format("{0:00,000}", (UNIMaxPrice() / 10000)); // max değer
            label18.Text = String.Format("{0:00,000}", (UNIMinPrice() / 10000)); // min değer 
            label19.Text = String.Format("{0:00,000}", (UNI24Change() / 10000)); // 24 saat değişim
            label20.Text = String.Format("{0:00,000}", (UNI24Average() / 10000)); // 24 saatlik ortalama
            double btcavarage = UNI24Average();
