...
{
    public partial class Xrp : Form
    {
        //XRP
        private static double xrpLastPrice()
        {


            WebClient wb = new WebClient();
            string btc = wb.DownloadString("https://api.binance.com/api/v3/ticker/24hr?symbol=XRPUSDT");
        ...
        private static double xrpMaxPrice()
        {
        ...
        private static double xrpMinPrice()
        {
        ...
        private static double xrp24Change()
        {
        ...
        private static double xrp24Average()
        {
        ...
        private void Xrp_Load(object sender, EventArgs e)
        {
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            label4.Text = String.Format("{0:00,000}", (xrpLastPrice() / 10000)); // son değer
            label5.Text = String.Format("{0:00,000}", (xrpMaxPrice() / 10000)); // max değer
            label18.Text = String.Format("{0:00,000}", (xrpMinPrice() / 10000)); // min değer 
            label19.Text = String.Format("{0:00,000}", (xrp24Change() / 10000)); // 24 saat değişim
            label20.Text = String.Format("{0:00,000}", (xrp24Average() / 10000)); // 24 saatlik ortalama
            double btcavarage = xrp24Average();
