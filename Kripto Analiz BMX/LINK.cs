...
namespace Kripto_Analiz_BMX
{
    public partial class LINK : Form
    {
        ...
        //ChainLink LİNK
        private static double LINKLastPrice()
        {


            WebClient wb = new WebClient();
            string btc = wb.DownloadString("https://api.binance.com/api/v3/ticker/24hr?symbol=LINKUSDT");
        ...
        private static double LINKMaxPrice()
        {
        ...
        private static double LINKMinPrice()
        {
        ...
        private static double LINK24Change()
        {
        ...
        private static double LINK24Average()
        {
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            label4.Text = String.Format("{0:00,000}", (LINKLastPrice() / 10000)); // son değer
            label5.Text = String.Format("{0:00,000}", (LINKMaxPrice() / 10000)); // max değer
            label18.Text = String.Format("{0:00,000}", (LINKMinPrice() / 10000)); // min değer 
            label19.Text = String.Format("{0:00,000}", (LINK24Change() / 10000)); // 24 saat değişim
            label20.Text = String.Format("{0:00,000}", (LINK24Average() / 10000)); // 24 saatlik ortalama
            double btcavarage = LINK24Average();
