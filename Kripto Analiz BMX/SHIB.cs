...
{
    public partial class SHIB : Form
    {
        //Shiba Inu
        private static double SHIBLastPrice()
        {


            WebClient wb = new WebClient();
            string btc = wb.DownloadString("https://api.binance.com/api/v3/ticker/24hr?symbol=SHIBUSDT");
        ...
        private static double SHIBMaxPrice()
        {
        ...
        private static double SHIBMinPrice()
        {
        ...
        private static double SHIB24Change()
        {
        ...
        private static double SHIB24Average()
        {
        ...
        private void SHIB_Load(object sender, EventArgs e)
        {
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            DovizGoster();
            label4.Text = String.Format("{0}", (SHIBLastPrice() / 1000000)); // son değer
            label5.Text = String.Format("{0}", (SHIBMaxPrice() / 1000000)); // max değer
            label18.Text = String.Format("{0}", (SHIBMinPrice() / 1000000)); // min değer 
            label19.Text = String.Format("{0}", (SHIB24Change() / 100000)); // 24 saat değişim
            label20.Text = String.Format("{0}", (SHIB24Average() / 1000000)); // 24 saatlik ortalama
            double btcavarage = SHIB24Average();

            double destek1 = Destek1(btcavarage) / 100000;

            label21.Text = Convert.ToString(destek1);


            double destek2 = Destek2(btcavarage) / 100000;

            label22.Text = Convert.ToString(destek2);


            double direnc1 = Direnc1(btcavarage) / 100000;

            label23.Text = Convert.ToString(direnc1);


            double direnc2 = Direnc2(btcavarage) / 100000;
