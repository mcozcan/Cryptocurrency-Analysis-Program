...
namespace Kripto_Analiz_BMX
{
    public partial class DOT : Form
    {
        ...
        //Polkadot DOT
        private static double DOTLastPrice()
        {


            WebClient wb = new WebClient();
            string btc = wb.DownloadString("https://api.binance.com/api/v3/ticker/24hr?symbol=DOTUSDT");
        ...
        private static double DOTMaxPrice()
        {
        ...
        private static double DOTMinPrice()
        {
        ...
        private static double DOT24Change()
        {
        ...
        private static double DOT24Average()
        {
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            label4.Text = String.Format("{0:00,000}", (DOTLastPrice() / 10000)); // son değer
            label5.Text = String.Format("{0:00,000}", (DOTMaxPrice() / 10000)); // max değer
            label18.Text = String.Format("{0:00,000}", (DOTMinPrice() / 10000)); // min değer 
            label19.Text = String.Format("{0:00,000}", (DOT24Change() / 10000)); // 24 saat değişim
            label20.Text = String.Format("{0:00,000}", (DOT24Average() / 10000)); // 24 saatlik ortalama
            double btcavarage = DOT24Average();
