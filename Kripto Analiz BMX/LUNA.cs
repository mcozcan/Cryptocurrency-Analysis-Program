...
namespace Kripto_Analiz_BMX
{
    ...
    {
        //Terra LUNA
        private static double LUNALastPrice()
        {


            WebClient wb = new WebClient();
            string btc = wb.DownloadString("https://api.binance.com/api/v3/ticker/24hr?symbol=LUNAUSDT");
        ...
        private static double LUNAMaxPrice()
        {
        ...
        private static double LUNAMinPrice()
        {
        ...
        private static double LUNA24Change()
        {
        ...
        private static double LUNA24Average()
        {
        ...
        private void LUNA_Load(object sender, EventArgs e)
        {
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            label4.Text = String.Format("{0:00,000}", (LUNALastPrice() / 10000)); // son değer
            label5.Text = String.Format("{0:00,000}", (LUNAMaxPrice() / 10000)); // max değer
            label18.Text = String.Format("{0:00,000}", (LUNAMinPrice() / 10000)); // min değer 
            label19.Text = String.Format("{0:00,000}", (LUNA24Change() / 10000)); // 24 saat değişim
            label20.Text = String.Format("{0:00,000}", (LUNA24Average() / 10000)); // 24 saatlik ortalama
            double btcavarage = LUNA24Average();
