...
namespace Kripto_Analiz_BMX
{
    public partial class NEO : Form
    {
        ...
        //Neo
        private static double NEOLastPrice()
        {


            WebClient wb = new WebClient();
            string btc = wb.DownloadString("https://api.binance.com/api/v3/ticker/24hr?symbol=NEOUSDT");
        ...
        private static double NEOMaxPrice()
        {
        ...
        private static double NEOMinPrice()
        {
        ...
        private static double NEO24Change()
        {
        ...
        private static double NEO24Average()
        {
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            label4.Text = String.Format("{0:00,000}", (NEOLastPrice() / 10000)); // son değer
            label5.Text = String.Format("{0:00,000}", (NEOMaxPrice() / 10000)); // max değer
            label18.Text = String.Format("{0:00,000}", (NEOMinPrice() / 10000)); // min değer 
            label19.Text = String.Format("{0:00,000}", (NEO24Change() / 10000)); // 24 saat değişim
            label20.Text = String.Format("{0:00,000}", (NEO24Average() / 10000)); // 24 saatlik ortalama
            double btcavarage = NEO24Average();
            ...
            {
                label25.Text = "AL ve BEKLET - akıllı adamsın iyi zamanda almışsın YTD ;)";
            }
        }
    }
}
