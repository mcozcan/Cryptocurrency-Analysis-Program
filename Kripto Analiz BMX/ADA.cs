...
namespace Kripto_Analiz_BMX
{
    public partial class ADA : Form
    {
        ...
        private static double adaLastPrice()
        {


            WebClient wb = new WebClient();
            string btc = wb.DownloadString("https://api.binance.com/api/v3/ticker/24hr?symbol=ADAUSDT");
        ...
        private static double adaMaxPrice()
        {
        ...
        private static double adaMinPrice()
        {
        ...
        private static double ada24Change()
        {
        ...
        private static double ada24Average()
        {
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            label4.Text = String.Format("{0:00,000}", (adaLastPrice() / 10000)); // son değer
            label5.Text = String.Format("{0:00,000}", (adaMaxPrice() / 10000)); // max değer
            label18.Text = String.Format("{0:00,000}", (adaMinPrice() / 10000)); // min değer 
            label19.Text = String.Format("{0:00,000}", (ada24Change() / 10000)); // 24 saat değişim
            label20.Text = String.Format("{0:00,000}", (ada24Average() / 10000)); // 24 saatlik ortalama
            double btcavarage = ada24Average();
