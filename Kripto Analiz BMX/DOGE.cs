...
{
    public partial class DOGE : Form
    {
        //Dogecoin DOGE
        private static double DOGELastPrice()
        {


            WebClient wb = new WebClient();
            string btc = wb.DownloadString("https://api.binance.com/api/v3/ticker/24hr?symbol=DOGEUSDT");
        ...
        private static double DOGEMaxPrice()
        {
        ...
        private static double DOGEMinPrice()
        {
        ...
        private static double DOGE24Change()
        {
        ...
        private static double DOGE24Average()
        {
        ...
        private void DOGE_Load(object sender, EventArgs e)
        {
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            label4.Text = String.Format("{0:00,000}", (DOGELastPrice() / 10000)); // son değer
            label5.Text = String.Format("{0:00,000}", (DOGEMaxPrice() / 10000)); // max değer
            label18.Text = String.Format("{0:00,000}", (DOGEMinPrice() / 10000)); // min değer 
            label19.Text = String.Format("{0:00,000}", (DOGE24Change() / 10000)); // 24 saat değişim
            label20.Text = String.Format("{0:00,000}", (DOGE24Average() / 10000)); // 24 saatlik ortalama
            double btcavarage = DOGE24Average();
